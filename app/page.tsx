...
export default async function HomePage() {
  ...
  const notePreview = resumeData.engineeringNotes.slice(0, 3);
        ...
        <Section id="notes-preview" className="!pt-12">
          <RevealWrapper delayMs={90}>
            <EditorialHeading
              as="h2"
              eyebrow="Notes"
              title="Engineering Notes Preview"
              description="Selected writing on production delivery decisions and trade-offs."
            />
            ...
            <div className="mt-5">
              <Link href="/notes" className={ctaClassName}>
                View All Notes
              </Link>
            </div>
          </RevealWrapper>
